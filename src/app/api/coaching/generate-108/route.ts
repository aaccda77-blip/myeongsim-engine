...
★ 각 필드는 반드시 50~80자! sajuAnalysis만 120~180자 허용. 절대 200자를 넘기지 마세요.

1. **title**: 시적 제목 (15자 이내)
2. **sajuAnalysis**: 이 주제에 대해 내 사주 4주(년주: ${getGanJi(fp.year)}, 월주: ${getGanJi(fp.month)}, 일주: ${getGanJi(fp.day)}, 시주: ${getGanJi(fp.time)})가 각각 어떤 영향을 주는지 쉬운 말로 풀어서 설명. 예: "년주의 ○○은 ~한 성향을, 일주의 ○○은 ~해요" (120~180자)
