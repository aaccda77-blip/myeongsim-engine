...
export async function POST(req: NextRequest) {
    try {
        ...
        const { depositorName = '', amount = 4900, userId = '', itemType = 'CHAT_PASS', orderName = '명심 챗봇 코칭 충전권 (4,900원)' } = body;
        ...
        return NextResponse.json({
            success: true,
            message: '무통장 입금 승인 신청이 성공적으로 접수되었습니다. 관리자 확인 후 즉시 코칭이 활성화됩니다.',
            pendingItem,
            bankInfo: {
                bank: '토스뱅크',
