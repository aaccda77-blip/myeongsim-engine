  ...
  try {
    ...
    return NextResponse.json({
      ...
      coaching: {
        ...
        awareness: '모든 것이 완벽하게 돌아가야 한다는 통제를 내려놓고 잠시 숨을 고르세요. 결과와 상관없이 지금 이 순간을 수용합니다. (Zero Point)',
        msc_common_humanity: '지연이나 예상치 못한 오류 앞에서 조급해지는 것은 누구에게나 자연스러운 인간의 보편적 반응입니다.',
        msc_self_kindness: '오류를 마주하고도 차분히 기다려주는 당신 자신에게 따뜻한 미소를 보내주세요.'
      }
    });
  }
}
