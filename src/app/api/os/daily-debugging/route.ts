...

{
      ...
      "innerSourceCode": "마음속 숨겨진 상처 (4대 심리 치료법 CBT·DBT·ACT·MBCT의 통찰을 통합하여, 사용자의 기질이 오늘 현실에서 부딪히기 쉬운 내면 깊은 곳의 상처나 오해를 다정한 이야기처럼 설명하세요. 4대 기법을 자연스레 녹이되 딱딱한 학술어 대신 **(CBT: 다정한 생각 점검)**, **(ACT: 마음의 나침반)**, **(DBT: 아픔 안아주기)**, **(MBCT: 고요한 바라봄)** 형태로 부드럽고 예쁘게 태그를 병기하여 설명하세요)",
    ...
    2. 4대 마음 치료법의 개념을 초보자도 바로 이해하고 감동받을 수 있도록 지극히 포근한 힐러의 음성으로 풀어내세요.
