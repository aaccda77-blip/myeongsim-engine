...

{
  ...
  "coaching": {
    "desc": "명심 코칭 풀이 (오늘의 에너지 상태와 일진에 근거하여 왜 이러한 무의식 저항과 외부 현실의 짝이 일어났는지에 대한 원리 해설)",
    ...
    "awareness": "Zero Point 솔루션 (오늘의 바이오리듬과 모드에 맞게, 텅 빈 마음으로 에고를 내려놓고 내면의 영점을 회복하는 구체적인 행동 처방)"
  }
}
