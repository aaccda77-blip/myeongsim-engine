...
const SCENARIO_STEPS: ScenarioStep[] = [
    ...
    },
    {
        ...
        icon: '⚡',
        title: '스트레스 스파이크 감지!',
        subtitle: '회의 중 의견 충돌 발생',
        type: 'alert',
        color: 'red',
        bioData: { bpm: 98, hrv: 28, stress: 'HIGH' },
        details: [
            '심박수 급등: 68 → 98 BPM (44% 상승)',
            'HRV 급락: 52 → 28ms (46% 하락)',
            '스트레스 지수: HIGH 전환',
    ...
    },
    {
        ...
        icon: '🔍',
        title: '기질 × 생체 교차 분석',
        subtitle: 'Bio-Neural Fusion Engine 가동',
        type: 'analysis',
        color: 'purple',
        details: [
            '● 현재 활성 신경망: 배경 신경망 (주도성 엔진)',
            '● 감지된 다크코드: "고집불통 독재자" 모드',
            '● 트리거 원인 추정: 의견 충돌 → 통제 욕구 폭주',
            '● 위험도: ████████░░ 80%',
            '● 분석 근거: HRV 28ms + 심박 98BPM + 주도성 엔진 다크코드 패턴 일치',
        ],
    },
    {
        id: 4,
        ...
        icon: '🛡️',
        title: '맞춤형 코칭 자동 푸시',
        subtitle: '3단계 질문 + CBT 개입',
        type: 'coaching',
        color: 'blue',
        coachingMsg: '🧠 명심 마스터: 주도성 엔진의 다크코드가 활성화되었습니다.\n\n지금 끓어오르는 그 분노를 한 걸음 뒤에서 바라봐 주세요.\n\n💭 산파술 질문:\n"지금 이 논쟁에서 이기고 싶은 것은 문제 해결인가, 아니면 자존심인가?"\n\n🌊 즉시 개입 (MBCT):\n양손을 펴고 10초간 손바닥을 관찰하세요.\n호흡과 함께 "통제하려는 충동이 올라오고 있구나" 라고 명명하세요.',
        details: [
            '✅ 푸시 알림 전송 완료',
            '✅ 산파술 질문 1개 전달',
            '✅ MBCT 즉시 개입 가이드 전달',
