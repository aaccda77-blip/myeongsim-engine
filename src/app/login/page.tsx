...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-[#050B14]">
                ...
                <div className="backdrop-blur-2xl bg-white/[0.03] border border-white/[0.08] rounded-3xl p-8 shadow-[0_30px_60px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                    ...
                    <div className="relative flex flex-col items-center text-center">
                        ...
                        <motion.div
                            ...
                            className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-blue-600 to-purple-600 p-[1px] shadow-lg shadow-blue-500/20 mb-8"
                        >
                            <div className="w-full h-full rounded-2xl bg-[#0A0F16] flex items-center justify-center relative overflow-hidden">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-purple-500/20 opacity-50"></div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <button
                                ...
                                disabled={isLoading}
                                className="group relative w-full flex items-center justify-center gap-3 bg-white text-[#0A0F16] font-semibold py-4 px-6 rounded-xl transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
                            >
                                {isLoading ? (
