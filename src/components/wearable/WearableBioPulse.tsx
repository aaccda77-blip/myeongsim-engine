    ...
    return (
        <div className="flex flex-col items-center justify-between h-full py-2 px-2 text-center select-none font-sans w-full">
            ...
            <div className="flex items-center justify-between w-full px-2 pt-1">
                <span className="text-[10px] font-mono font-bold tracking-widest text-gray-400 flex items-center gap-1">
            ...
            <div className="relative my-auto flex flex-col items-center justify-center">
                ...
                <div className="w-[200px] mt-1 bg-black/40 border border-white/10 rounded-xl p-1.5 px-2.5">
            ...
            {/* 하단 퀵 액션 버튼 */}
            <div className="w-full max-w-[210px] pb-1 space-y-1">
                {isHighStress ? (
                    <button
                        onClick={onGoToEmergency || onGoToBreath}
                        className="w-full py-2 px-3 rounded-full bg-red-600 hover:bg-red-500 active:scale-95 text-white text-[11px] font-black flex items-center justify-center gap-1.5 shadow-[0_0_12px_rgba(239,68,68,0.5)] transition-all cursor-pointer"
                    >
                        <ShieldAlert size={12} />
                    ...
                    <button
                        ...
                        className="w-full py-1.5 px-3 rounded-full bg-white/10 hover:bg-white/20 active:scale-95 text-white text-[11px] font-bold flex items-center justify-center gap-1 border border-white/15 transition-all cursor-pointer"
                    >
