...
const ILGAN_COACHING_DB: Record<string, IlganCoaching> = {
    '辛': {
        ...
        masterRoadmap: {
            ...
            leverages: [
                { type: 'Tech', title: '기술적 레버리지 (자동화)', desc: '코어 로직(명심코칭)을 대중에게 전달하는 배달망은 AI가 대신해야 합니다.', items: ['AI 스캔 엔진을 통한 1차 분석 자동화', '무인 데이터 접수 및 64괘 기질 분류 완료', '지능형 시스템 기반 1:1 맞춤 코칭 연동'] },
                ...
                sections: [
                    {
                        ...
                        scenarioTitle: "[24시간 AI 무인 코칭 파이프라인 프로세스]",
                        steps: [
                            "1단계 (24시간 무인 데이터 접수): 내담자가 웹사이트에서 자신의 생년월일시와 심리적 문제(버그)를 입력하면, 시스템이 무인 파이프라인으로 데이터를 안전하게 분류 저장합니다.",
                            "2단계 (지능형 AI 스캔 엔진 가동): 접수 즉시 64괘 기질 분석 알고리즘이 자동으로 가동되어 내담자의 뇌 신경망 패턴을 스캔합니다.",
                            "3단계 (1차 분석 리포트 자동 생성): AI 코치가 내담자의 사주 기질과 멘탈 과학 분석 로직을 적용하여 10초 만에 '1차 디버깅 초안'을 완성해 둡니다.",
                            "4단계 (대표님의 1:1 핵심 솔루션 제공): 대표님은 백지상태에서 시작할 필요 없이 AI가 마련한 초안을 바탕으로, 단 1개의 날카로운 산파술 질문(SHIFT)으로 내담자에게 감동을 선사합니다."
                        ],
                        insight: "💡 辛金 아키텍트의 마인드셋: \"나는 AI가 채굴한 원석을 세공하는 명장이다. 채굴(초기 수집)은 기계가, 최종 빛을 내는 가공(SHIFT Trigger)은 나만이 할 수 있다.\""
                    },
                    {
                        title: "2. 인적 레버리지: 辛金의 정밀 분석 브랜드 구축하기",
                        desc: "辛金의 가장 큰 비즈니스 자산은 '남이 보지 못하는 오류를 잡아내는 예리한 분석력'입니다. 이 능력을 레버리지화하여 '정밀 심리 분석 전문가'로 포지셔닝하십시오. 기업 HR 부서, 코칭 기관, 자격증 과정이 핵심 타깃입니다.",
                        scenarioTitle: "[辛金 추천 직업·비즈니스 경로]",
                        items: [
                            { label: "💎 정밀 심리 분석 리포트 서비스", action: "대표님의 역할: 사주 기질 데이터 + CBT/ACT 기반 인지 왜곡 분석 로직을 결합한 '프리미엄 1:1 정밀 분석 리포트' 상품을 설계하십시오. 가격은 30-50만원 구간이 적정합니다.\n레버리지의 역할: 리포트 레이아웃 디자인, PDF 자동 생성 시스템(AI 파이프라인+Notion), 결제 페이지는 모두 외주·자동화로 처리합니다. 대표님은 오직 분석 로직과 SHIFT 질문 설계에만 집중하십시오." },
                    ...
                    },
                    {
                        ...
                        steps: [
                            "AI가 만든 분석 리포트 초안이 95점이 아닌 80점이어도, 내담자에게 먼저 보내고 피드백을 받습니다. 완벽한 리포트보다 빠른 피드백 루프가 더 귀합니다.",
                        ...
                        insight: "辛金 대표님께 지금 당장 이번 주 테스트해볼 수 있는 레버리지가 있습니다. '정밀 분석 리포트 베타 상품'을 지인 1명에게 무료로 제공하고 솔직한 피드백을 받는 것입니다. 완성을 기다리지 마십시오."
                    }
                ]
            }
        }
                ...
                sections: [
                    {
                        ...
                        scenarioTitle: "[24시간 AI 무인 코칭 파이프라인 프로세스]",
                        steps: [
                            "1단계 (데이터 수집 자동화): 내담자가 명심코칭 웹사이트(Next.js)에서 자신의 생년월일시와 현재 겪고 있는 심리적 문제(버그)를 입력합니다. 이 데이터는 안전 분석 서버에 즉각 저장됩니다.",
                            "2단계 (AI 파이프라인 트리거 및 API 통신): 데이터가 들어오는 순간, AI 파이프라인이 자동으로 작동하여 내담자의 데이터를 지능형 AI 엔진로 쏩니다.",
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { label: "🏆 기업 임원 리더십 워크숍 (B2B)", action: "대표님의 역할: 기업의 팀장·임원을 대상으로 '사주 기질 기반 리더십 스타일 분석 + 돌파형 리더십 워크숍' 프로그램을 기업에 제안하십시오. 甲木의 카리스마는 기업 교육 현장에서 강력하게 빛납니다.\n레버리지의 역할: 기업 교육 플랫폼(숨고·탈잉·클래스101 비즈)에 입점하여 인바운드 문의를 자동으로 받는 구조를 만드십시오. 영업보다 플랫폼이 대신 홍보합니다." }
                        ],
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { label: "🤝 관계 코칭 & 인맥 설계 컨설팅", action: "대표님의 역할: '사주 기질 기반 관계 패턴 분석 + 핵심 인맥 설계 전략'을 주제로 한 1:1 또는 소그룹 컨설팅 서비스를 설계하십시오. 비즈니스 관계에서 갈등을 겪는 대표·프리랜서가 주요 타깃입니다.\n레버리지의 역할: 예약 시스템(캘리·폼), 리포트 자동화(Notion+AI 파이프라인), 결제 페이지는 자동화로 처리합니다. 대표님은 실질적인 관계 설계 인사이트 전달에만 집중하십시오." }
                        ],
    ...
    '丁': {
        ...
        masterRoadmap: {
            ...
            microManual: {
                title: "마이크로 실행 매뉴얼",
                intro: "丁火(정화) 대표님, 당신의 섬세한 불꽃은 모든 내담자에게 직접 닿으려 할 때 빨리 소진됩니다. AI와 자동화는 대표님이 1:1 깊은 치유에 집중할 수 있도록 초기 분석·분류 작업을 대신하는 '촛불 보조 심지' 역할을 합니다.\n丁火 명심코칭의 3S(SCAN, SYNC, SHIFT) 시스템 무한 확장을 위한 파이프라인 설계도입니다.",
                sections: [
                    {
                        title: "1. 기술적 레버리지: AI와 자동화로 'SCAN & SYNC' 초안 맡기기",
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { label: "🌙 소수 정예 감정 케어 그룹 프로그램 (4-6인)", action: "대표님의 역할: 같은 상처 유형(이직 트라우마·관계 상처·자존감 회복 등)을 가진 4-6명을 모아 8주 과정의 소규모 치유 그룹 프로그램을 운영하십시오. 1회에 4명만 만나도 동시에 4배의 수익이 발생합니다.\n레버리지의 역할: 참가자 모집 랜딩페이지·그룹 카카오채팅방 세팅·수료증 발급은 프리랜서에게 위임하십시오. 대표님은 그룹 세션 진행에만 집중하십시오." }
                        ],
            ...
            microManual: {
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            { label: "🏔️ 기업 조직문화 분석 & 장기 자문 계약 (B2B 리테이너)", action: "대표님의 역할: 중견·중소기업의 HR팀·대표에게 '사주 기질 기반 조직문화 분석 + 분기별 팀빌딩 코칭 자문' 리테이너 계약(월 정기 자문료)을 제안하십시오. 戊土의 묵직한 안정감은 기업이 장기 파트너로 신뢰하는 요소입니다.\n레버리지의 역할: 제안서 작성·계약서 검토·세금계산서 발행·일정 조율은 프리랜서 비서나 세무사에게 위임하십시오. 대표님은 수주 미팅과 실제 자문 세션에만 집중하십시오." },
                    ...
                    },
                    {
                        ...
                        insight: "戊土 대표님이 이번 주 바로 테스트해볼 레버리지: 기업 1곳을 골라 '조직문화 분석 무료 체험 세션(1시간)' 제안 메일을 작성하십시오. 보내기 전에 AI에게 '제안서 다듬어줘'라고 요청해보십시오. AI 협업의 첫 경험이 시작됩니다."
                    }
                ]
            }
        }
            ...
            microManual: {
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            { label: "⚔️ 기업 CEO·임원 전용 결과 중심 코칭 (Results-Based)", action: "대표님의 역할: '사주 기질 기반 리더십 분석 + 3개월 결과 중심 임원 코칭' 패키지를 설계하십시오. 1회당 20-50만원 이상의 고가 프리미엄 구조로 책정하십시오. 庚金의 직설적·원칙적 스타일은 결과를 갈망하는 임원들에게 신선한 충격으로 작용합니다.\n레버리지의 역할: 코칭 계약서·결제·세금계산서·일정 조율은 프리랜서 비서에게 위임하십시오. 대표님은 오직 '실제 코칭 세션에서 핵심을 꿰뚫는 1개의 질문'을 설계하는 데만 집중하십시오." },
                            { label: "🏆 조직 성과 관리 & 위기 대응 자문 (B2B 리테이너)", action: "대표님의 역할: 조직 내 성과 부진·갈등·인사 문제를 겪는 기업에 '성과 분석 + 분기별 위기 대응 자문' 리테이너 계약을 제안하십시오. 庚金의 냉철한 판단력은 기업이 위기 상황에서 가장 필요로 하는 능력입니다.\n레버리지의 역할: 기업 HR 플랫폼(링크드인·탈잉 비즈·크몽 엔터프라이즈)에 프로필을 등록해 인바운드 문의를 자동으로 유입시키십시오. 영업은 플랫폼이, 타격은 대표님이 담당하십시오." }
                        ],
                    ...
                    },
                    {
                        ...
                        insight: "지금 말씀드린 AI 파이프라인을 활용한 데이터 파이프라인 구축이나, 프리랜서를 통한 조판 외주화 중에서 당장 이번 주에 가볍게 테스트해보고 싶은 레버리지 영역은 어느 쪽이신가요?"
                    }
                ]
            }
        }
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { label: "🧭 고가 전략 컨설팅 & 패러다임 전환 코칭 (VIP 소수 정예)", action: "대표님의 역할: '사주 기질 기반 비즈니스 전략 분석 + 6개월 그랜드 아키텍트 코칭' 패키지를 설계하십시오. 1회당 30-80만원 이상의 최고가 구조로 책정하십시오. 壬水의 다차원 전략 시뮬레이션 능력은 경영자가 수백만 원을 지불할 가치가 있습니다.\n레버리지의 역할: 계약서·결제·일정 관리는 프리랜서 비서에게 맡기십시오. 대표님은 세션 전 AI 리포트를 검토하고, '내담자의 비즈니스 패턴에서 아무도 보지 못한 맹점 하나'를 찾아내는 데에만 집중하십시오." }
                        ],
