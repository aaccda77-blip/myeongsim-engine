...
const ILGAN_COACHING_DB: Record<string, IlganCoaching> = {
    '辛': {
        heroQuote: '"당신의 고통은 버그가 아닙니다. 완벽한 디버깅 CPU(辛金)로 빛나기 위한 정밀 프로세싱 과정입니다."',
        ...
        masterRoadmap: {
            ...
            shifts: [
                ...
                { step: '3단계', title: 'AI와 기술을 통한 레버리지', desc: '냉철한 금(金)의 기운은 자동화와 AI를 의미합니다. 오프라인을 넘어 언제 어디서든 구동되는 확장 가능한 플랫폼으로 진화해야 합니다.', action: "Next.js, 안전 분석 서버, AI 파이프라인 등을 활용한 백엔드 무인 자동화 연동" }
            ],
            dailyMissions: [
            ...
            leverages: [
                { type: 'Tech', title: '시스템 레버리지 (자동 확장)', desc: '명심코칭의 깊은 영혼 지혜를 대중에게 전달하는 무인 배달망 시스템입니다.', items: ['지능형 스캔 엔진을 통한 1차 분석 완료', '64괘 사주 기질 분류 및 1:1 맞춤 연동', '자동화 시스템 기반 1:1 영혼 코칭 서빙'] },
            ...
            microManual: {
                          "title": "마이크로 1:1 영혼 코칭 실행 매뉴얼",
                          "intro": "辛金(신금) 대표님, 60갑자 중 가장 섬세하고 빛나는 보석의 기질을 지닌 당신을 위한 1:1 맞춤형 마이크로 실행 가이드입니다. 세상을 향해 당신의 고귀한 가치를 빛내는 3대 감동 실천 솔루션을 전해드립니다.",
                          "sections": [
                                    {
                                              "title": "1. 💎 辛金의 완벽주의를 내려놓는 80% 미학의 기술",
                                              "desc": "원석이 정교한 보석으로 거듭나는 과정에는 수많은 마찰과 세공의 시간이 존재합니다. 辛金 일간 대표님, 완성도 100점짜리 무결점 작품을 내놓으려 애쓰다, 정작 세상과의 소통을 멈추고 계셨던 적은 없으셨습니까? 80%의 진심이 담긴 미완성의 초안이, 세상의 빛을 보지 못한 100% 완벽보다 천 배 더 위대합니다. 오늘 당신의 날카로운 완벽주의 칼날을 나 자신을 옥죄는 데 쓰지 말고, 세상을 깨우는 훌륭한 세공 도구로 사용하십시오.",
                                              "scenarioTitle": "[오늘 당장 실천하는 3단계 뇌 디버깅 루틴]",
                                              "steps": [
                                                        "1단계 [수용]: 오늘 하고 있던 작업 중 80% 완성된 것에 3초간 깊은 호흡 후 즉시 마침표 찍기",
                                                        "2단계 [전환]: '완벽하지 않아도 내 진심은 이미 충분히 빛난다'고 스스로에게 나직하게 말해주기",
                                                        "3단계 [실행]: 완성된 80%의 가치를 멈추지 말고 지금 당장 딱 한 사람에게 용기 있게 전달하기"
                                              ],
                                              "insight": "💡 辛金 아키텍트의 마인드셋: \"나는 내 작품의 가장 엄격한 비판자가 아니라, 세상을 아름답게 바꾸는 정교한 빛의 세공사다.\""
                                    },
                                    {
                                              "title": "2. 🌿 巳火 정관의 압박감을 자유로운 성장으로 바꾸는 지혜",
                                              "desc": "일지의 巳火(정관)는 당신에게 깊은 사회적 책임감과 명예를 선물하지만, 때로는 타인의 시선에 갇히는 단단한 감옥이 되기도 합니다. 모든 사람의 기대에 부응하려 애쓰지 마십시오. 당신은 남들의 기대치에 맞춰 다듬어진 진열장의 장식품이 아니라, 스스로 온 영토를 비추는 단 하나의 자비로운 보석입니다. 타인의 평가에서 벗어날 때 당신의 가치는 진정한 빛을 발합니다.",
                                              "scenarioTitle": "[내면의 자유를 회복하는 3단계 실천 가이드]",
                                              "steps": [
                                                        "1단계 [알아차림]: 타인의 시선에 마음이 억눌리는 순간, 3초간 눈을 감고 발바닥 감각 인지하기",
                                                        "2단계 [경계 설정]: 무리한 부탁이나 기대에 대해 '생각해 보겠습니다'라고 우아하게 거절 선언하기",
                                                        "3단계 [자유]: 오늘 하루 오롯이 나만의 내면을 위해 15분간 완벽한 오프라인 진공 휴식 갖기"
                                              ],
                                              "insight": "💡 辛金 비즈니스 마인드셋: \"타인의 인정보다 더 위대한 것은 나 자신과의 깊은 평화와 현존이다.\""
                                    },
                                    {
                                              "title": "3. 🌊 癸水 식신의 창의성을 세상의 재물(木)로 연결하는 퀀텀 쉼프트",
                                              "desc": "월간의 癸水(식신)는 당신의 가슴속에서 솟구치는 맑은 샘물 같은 영감과 창의적 아이디어입니다. 이 샘물이 홀로 고여있으면 습기가 되지만, 세상으로 흘러가 乙木(재성)이라는 대지를 적실 때 비로소 거대한 풍요의 숲을 이룹니다. 머릿속에만 맴돌던 영감을 글이나 커뮤니케이션으로 세상과 연결하세요.",
                                              "scenarioTitle": "[창의성을 풍요로 바꾸는 3단계 마이크로 스텝]",
                                              "steps": [
                                                        "1단계 [발상]: 오늘 내 머릿속을 맴돈 사소한 아이디어 1개를 노트나 일기에 기록하기",
                                                        "2단계 [연결]: 이 아이디어가 다른 사람의 어떤 고민을 해결해 줄 수 있는지 한 문장으로 정의하기",
                                                        "3단계 [수확]: 머뭇거리지 않고 내 아이디어를 가치 있는 콘텐츠나 행동으로 세상에 공개하기"
                                              ],
                                              "insight": "💡 辛金 퀀텀 마인드셋: \"나의 창의적 영감은 세상을 이롭게 하는 가장 고귀한 선물이다.\""
                                    }
                          ]
                }
        }
    ...
    '甲': {
        heroQuote: '"당신의 고통은 부러짐이 아닙니다. 새로운 영역을 개척하는 메인 프레임(甲木)의 확장 스케일링입니다."',
        ...
        masterRoadmap: {
            engines: [
                ...
                { label: '중앙 처리 장치 (甲木)', title: '막힘없이 거침없이 앞서 나가는 용감한 도전 정신', desc: '목적지가 정해지면 뒤돌아보지 않습니다. 복잡성을 배제하고 가장 직선적인 경로(Fast-Track)를 계산하는 코어입니다.' },
                { label: '에너지 방열 및 출력 포트 (火 식상)', title: '가슴 속 꿈을 사람들에게 따뜻하게 전하는 비전 전달자', desc: '고성능 추진 과정에서 발생하는 내부 열기를 타인을 향한 따뜻한 비전 발산과 전략적 언어로 완벽히 방열합니다.' },
                { label: '최종 결과물 및 네트워크 (土 재성)', title: '사람들의 마음을 얻고 깊은 신뢰를 구축하는 든든한 울타리', desc: '지속 가능한 시스템과 사람들의 신뢰 위에 바로 서는 법. 사람들의 신뢰 데이터베이스 위에서 구축되는 지능형 비즈니스 네트워크입니다.' }
            ],
            shifts: [
                ...
                { step: '3단계', title: '결과의 뿌리내림 (System)', desc: '단순한 아이디어를 넘어 대중이 밟고 설 수 있는 견고한 플랫폼(조직/기업)으로 전환합니다.', action: "혼자 애쓰지 않고 함께 성과를 만들어가는 든든한 팀과 시스템 완성" }
            ],
            dailyMissions: [
                { time: '오전', mode: 'SCAN 모드', state: '마음의 소리에 귀 기울이고 오늘 꼭 이루고 싶은 소중한 결심 1가지 확정', action: '미래 트렌드 분석 및 오늘 돌파해야 할 가장 핵심적인 목표 1가지 확정' },
                { time: '오후', mode: 'SYNC 모드', state: '함께하는 사람들의 마음을 보살피고 온기를 나누는 시간', action: '주변 사람들과 대화하며 속도 차이를 조절. 3초간 멈추고 경청하기 훈련' },
                { time: '저녁', mode: 'SHIFT 모드', state: '오늘 하루를 감사히 돌아보고 다음 날을 튼튼하게 준비하기', action: '거시적 목표를 위한 현실적(재무/조직) 인프라가 튼튼한지 검수' }
            ],
            bugs: [
                { id: 'ERR_甲_01', name: '혼자 짐을 짊어지려는 과도한 책임감', symptom: '타협을 거부하고 혼자 돌진하다가 뿌리가 뽑힘. 주변에 온기가 없어 고립되는 현상.', patch: '상대방의 말이 끝날 때까지 따뜻하게 웃으며 끝까지 들어주기. 함께 가는 것이 궁극적 속도임을 체화.' },
                { id: 'ERR_甲_02', name: '마음이 여유 없이 건조해진 상태', symptom: '건조한 추진력만 남아, 행동은 크지만 성과는 잎을 틔우지 못하는 버그.', patch: '타인이 겪고 있는 고통에 진심으로 공감하는 연습(수분 공급)을 의도적으로 스케줄링.' }
            ],
            leverages: [
                { type: 'Tech', title: '지혜로운 사람들의 경험과 데이터를 성장의 거울로 삼기', desc: '직관에 의한 결정을 보완해 줄 확실한 데이터 백업 시스템이 필요합니다.', items: ['AI 기반의 시장 분석 툴로 맹점(Blind-spot) 방어', '경영 성과(KPI) 자동 추적 시스템 도입'] },
                { type: 'Human', title: '작은 디테일은 믿을 수 있는 분에게 맡기고 나는 거시적 비전에 몰입하기', desc: '최전방 개척은 대표님이, 그 뒤를 수습하고 관리하는 일은 위임하십시오.', items: ['인사/재무 관리 전문가 영입', '세세한 디테일보다 거시적 방향성 설정에 90% 리소스 투입'] }
            ],
            coreRole: [
            ...
            microManual: {
                          "title": "마이크로 1:1 영혼 코칭 실행 매뉴얼",
                          "intro": "甲木(갑목) 대표님, 60갑자 중 가장 먼저 솟구치는 거목의 기질을 지닌 당신을 위한 1:1 맞춤형 마이크로 실행 가이드입니다. 홀로 모든 부담을 짊어지던 독단 과부하를 내려놓고, 세상과 함께 거대한 숲을 가꾸는 3대 감동 실천 솔루션을 전해드립니다.",
                          "sections": [
                                    {
                                              "title": "1. 🌲 거목의 고독한 조급함을 내려놓는 숲의 연대 기술",
                                              "desc": "나 혼자 모든 것을 개척해야 한다는 강박은 당신의 열정이 아닌, 뇌의 고독한 조급함이 만든 환상입니다. 甲木 대표님, 뒤를 돌아보지 않고 나홀로 전쟁을 치르느라 정작 당신의 뿌리가 타들어가고 있지는 않습니까? 거목은 혼자 숲을 이룰 수 없습니다. 팀원과 타인의 피드백을 당신의 비전을 위협하는 공격이 아닌, 숲을 함께 가꾸는 촉촉한 단비로 받아들이십시오.",
                                              "scenarioTitle": "[오늘 당장 실천하는 3단계 뇌 디버깅 루틴]",
                                              "steps": [
                                                        "1단계 [수용]: 반대 의견을 접할 때 즉각 반응하지 않고 3초간 깊게 호흡하기",
                                                        "2단계 [전환]: '이 피드백은 나를 공격하는 것이 아니라 숲을 함께 키우는 단비다'라고 다독이기",
                                                        "3단계 [실행]: 상대방의 의견 중 유효한 1가지를 겸손하게 채택하고 고맙다고 말하기"
                                              ],
                                              "insight": "💡 甲木 아키텍트의 마인드셋: \"나는 외로운 독진 대장이 아니라, 모두가 안심하고 쉴 수 있는 거대한 숲의 설계자다.\""
                                    },
                                    {
                                              "title": "2. 💧 子水 정인의 수분을 온전히 흡수하는 휴식과 수용의 지혜",
                                              "desc": "대지 아래 깊은 수분(子水)이 마르면 잎사귀가 시들듯, 끊임없는 전진은 당신의 신경망을 고갈시킵니다. 매일 멈추어 서서 당신의 내면에 수분을 공급하십시오. 뒤처질까 봐 불안해하는 조급함을 내려놓고, 대지의 침묵 속에 머무를 때 비로소 진정한 통찰과 퀀텀 점프가 일어납니다.",
                                              "scenarioTitle": "[내면의 수분을 충전하는 3단계 실천 가이드]",
                                              "steps": [
                                                        "1단계 [알아차림]: 조급함이 솟구칠 때 즉시 가던 길을 멈추고 300ml 차가운 물 한 잔 마시기",
                                                        "2단계 [충전]: 하루 20분 의도적으로 모든 디지털 기기를 끄고 침묵 속 명상 갖기",
                                                        "3단계 [신뢰]: 오늘 다 해결하지 못한 일은 내일의 나에게 완벽하게 위임하고 깊은 수면 취하기"
                                              ],
                                              "insight": "💡 甲木 비즈니스 마인드셋: \"휴식은 지연이 아니라, 더 거대한 퀀텀 성장을 위한 최고의 영양 공급이다.\""
                                    },
                                    {
                                              "title": "3. ☀️ 丙火 식상의 열정을 세상의 결실로 바꾸는 융합 쉼프트",
                                              "desc": "당신의 가슴속에서 솟구치는 丙火(식상)의 뜨거운 열정을 혼자 껴안고 타오르지 마십시오. 당신의 비전과 리더십을 사람들과 나누고, 상대방의 잠재력을 깨워주는 따뜻한 햇살로 사용하십시오. 당신이 타인을 세워줄 때, 세상은 당신을 거대한 주권자로 추대합니다.",
                                              "scenarioTitle": "[열정을 결실로 바꾸는 3단계 마이크로 스텝]",
                                              "steps": [
                                                        "1단계 [발상]: 내가 가진 노하우 중 가장 가치 있는 단 1가지를 글로 정리해 보기",
                                                        "2단계 [공유]: 주변 사람 중 도움이 필요한 이에게 내 노하우를 기꺼이 아낌없이 나누기",
                                                        "3단계 [확장]: 타인의 성장을 기뻐하며 함께 더 큰 비전을 향해 손잡고 나아가기"
                                              ],
                                              "insight": "💡 甲木 퀀텀 마인드셋: \"내가 가장 빛나는 순간은 나 혼자 우뚝 섰을 때가 아니라, 모두를 빛나게 해줄 때다.\""
                                    }
                          ]
                }
        }
    ...
    '乙': {
        heroQuote: '"당신의 시련은 시듦이 아닙니다. 어떤 환경에도 유연하게 연결되는 분산 네트워크(乙木)의 적응력입니다."',
        ...
        masterRoadmap: {
            ...
            coreRole: [
                ...
                '경계선 강화를 이끄는 수용전념코칭(ACT) 스페셜리스트'
            ],
            microManual: {
                          "title": "마이크로 1:1 영혼 코칭 실행 매뉴얼",
                          "intro": "乙木(을목, 넝쿨·연결자) 대표님, 60갑자 중 고유한 기질을 지닌 당신을 위한 1:1 맞춤형 마이크로 실행 가이드입니다. 세상을 향해 당신의 고귀한 가치를 빛내는 3대 감동 실천 솔루션을 전해드립니다.",
                          "sections": [
                                    {
                                              "title": "1. 💎 乙木(을목, 넝쿨·연결자)의 완벽주의를 내려놓는 80% 미학의 기술",
                                              "desc": "원석이 정교한 보석으로 거듭나는 과정에는 수많은 마찰과 세공의 시간이 존재합니다. 乙木(을목, 넝쿨·연결자) 대표님, 완성도 100점짜리 무결점 작품을 내놓으려 애쓰다, 정작 세상과의 소통을 멈추고 계셨던 적은 없으셨습니까? 80%의 진심이 담긴 미완성의 초안이, 세상의 빛을 보지 못한 100% 완벽보다 천 배 더 위대합니다. 오늘 당신의 날카로운 자책을 내려놓고 세상을 바꾸는 훌륭한 세공 도구로 사용하십시오.",
                                              "scenarioTitle": "[오늘 당장 실천하는 3단계 뇌 디버깅 루틴]",
                                              "steps": [
                                                        "1단계 [수용]: 오늘 하고 있던 작업 중 80% 완성된 것에 3초간 깊은 호흡 후 즉시 마침표 찍기",
                                                        "2단계 [전환]: '완벽하지 않아도 내 진심은 이미 충분히 빛난다'고 스스로에게 나직하게 말해주기",
                                              ...
                                              "insight": "💡 乙木(을목, 넝쿨·연결자) 아키텍트의 마인드셋: \"나는 내 작품의 가장 엄격한 비판자가 아니라, 세상을 아름답게 바꾸는 정교한 빛의 세공사다.\""
                                    },
                                    {
                                              "title": "2. 🌿 사회적 압박감을 자유로운 성장으로 바꾸는 지혜",
                                              "desc": "사회적 책임감과 타인의 기대는 때로 당신을 가두는 단단한 감옥이 되기도 합니다. 모든 사람의 기대에 부응하려 애쓰지 마십시오. 당신은 남들의 기대치에 맞춰 다듬어진 장식품이 아니라, 스스로 온 영토를 비추는 단 하나의 자비로운 보석입니다. 타인의 평가에서 벗어날 때 당신의 가치는 진정한 빛을 발합니다.",
                                              "scenarioTitle": "[내면의 자유를 회복하는 3단계 실천 가이드]",
                                              "steps": [
                                                        "1단계 [알아차림]: 타인의 시선에 마음이 억눌리는 순간, 3초간 눈을 감고 발바닥 감각 인지하기",
                                                        "2단계 [경계 설정]: 무리한 부탁이나 기대에 대해 '생각해 보겠습니다'라고 우아하게 거절 선언하기",
                                              ...
                                              "insight": "💡 乙木(을목, 넝쿨·연결자) 비즈니스 마인드셋: \"타인의 인정보다 더 위대한 것은 나 자신과의 깊은 평화와 현존이다.\""
                                    },
                                    {
                                              "title": "3. 🌊 가슴속 창의성을 세상의 풍요로 연결하는 퀀텀 쉼프트",
                                              "desc": "당신의 가슴속에서 솟구치는 영감과 창의적 아이디어를 홀로 껴안고 계시지 마십시오. 세상으로 흘러가 사람들의 대지를 적실 때 비로소 거대한 풍요의 숲을 이룹니다. 머릿속에만 맴돌던 영감을 글이나 커뮤니케이션으로 세상과 연결하세요.",
                                              "scenarioTitle": "[창의성을 풍요로 바꾸는 3단계 마이크로 스텝]",
                                              "steps": [
                                                        "1단계 [발상]: 오늘 내 머릿속을 맴돈 사소한 아이디어 1개를 노트나 일기에 기록하기",
                                                        "2단계 [연결]: 이 아이디어가 다른 사람의 어떤 고민을 해결해 줄 수 있는지 한 문장으로 정의하기",
                                              ...
                                              "insight": "💡 乙木(을목, 넝쿨·연결자) 퀀텀 마인드셋: \"나의 창의적 영감은 세상을 이롭게 하는 가장 고귀한 선물이다.\""
                                    }
                          ]
                }
        }
    ...
    // ──────────────────────────────────────────────────────
    '丙': {
        heroQuote: '"당신의 과열은 번아웃이 아닙니다. 온 세상을 밝히는 중앙 프로세서(丙火)의 기운을 절제하는 법을 배우는 센싱 과정입니다."',
        ...
        masterRoadmap: {
            ...
            microManual: {
                          "title": "마이크로 1:1 영혼 코칭 실행 매뉴얼",
                          "intro": "丙火(병화, 태양·열정) 대표님, 60갑자 중 고유한 기질을 지닌 당신을 위한 1:1 맞춤형 마이크로 실행 가이드입니다. 세상을 향해 당신의 고귀한 가치를 빛내는 3대 감동 실천 솔루션을 전해드립니다.",
                          "sections": [
                                    {
                                              "title": "1. 💎 丙火(병화, 태양·열정)의 완벽주의를 내려놓는 80% 미학의 기술",
                                              "desc": "원석이 정교한 보석으로 거듭나는 과정에는 수많은 마찰과 세공의 시간이 존재합니다. 丙火(병화, 태양·열정) 대표님, 완성도 100점짜리 무결점 작품을 내놓으려 애쓰다, 정작 세상과의 소통을 멈추고 계셨던 적은 없으셨습니까? 80%의 진심이 담긴 미완성의 초안이, 세상의 빛을 보지 못한 100% 완벽보다 천 배 더 위대합니다. 오늘 당신의 날카로운 자책을 내려놓고 세상을 바꾸는 훌륭한 세공 도구로 사용하십시오.",
                                              "scenarioTitle": "[오늘 당장 실천하는 3단계 뇌 디버깅 루틴]",
                                              "steps": [
                                                        "1단계 [수용]: 오늘 하고 있던 작업 중 80% 완성된 것에 3초간 깊은 호흡 후 즉시 마침표 찍기",
                                                        "2단계 [전환]: '완벽하지 않아도 내 진심은 이미 충분히 빛난다'고 스스로에게 나직하게 말해주기",
                                              ...
                                              "insight": "💡 丙火(병화, 태양·열정) 아키텍트의 마인드셋: \"나는 내 작품의 가장 엄격한 비판자가 아니라, 세상을 아름답게 바꾸는 정교한 빛의 세공사다.\""
                                    },
                                    {
                                              "title": "2. 🌿 사회적 압박감을 자유로운 성장으로 바꾸는 지혜",
                                              "desc": "사회적 책임감과 타인의 기대는 때로 당신을 가두는 단단한 감옥이 되기도 합니다. 모든 사람의 기대에 부응하려 애쓰지 마십시오. 당신은 남들의 기대치에 맞춰 다듬어진 장식품이 아니라, 스스로 온 영토를 비추는 단 하나의 자비로운 보석입니다. 타인의 평가에서 벗어날 때 당신의 가치는 진정한 빛을 발합니다.",
                                              ...
                                              "insight": "💡 丙火(병화, 태양·열정) 비즈니스 마인드셋: \"타인의 인정보다 더 위대한 것은 나 자신과의 깊은 평화와 현존이다.\""
                                    },
                                    {
                                              "title": "3. 🌊 가슴속 창의성을 세상의 풍요로 연결하는 퀀텀 쉼프트",
                                              "desc": "당신의 가슴속에서 솟구치는 영감과 창의적 아이디어를 홀로 껴안고 계시지 마십시오. 세상으로 흘러가 사람들의 대지를 적실 때 비로소 거대한 풍요의 숲을 이룹니다. 머릿속에만 맴돌던 영감을 글이나 커뮤니케이션으로 세상과 연결하세요.",
                                              ...
                                              "insight": "💡 丙火(병화, 태양·열정) 퀀텀 마인드셋: \"나의 창의적 영감은 세상을 이롭게 하는 가장 고귀한 선물이다.\""
                                    }
                          ]
                }
        }
    ...
    // ──────────────────────────────────────────────────────
    '丁': {
        heroQuote: '"당신의 방전은 소멸이 아닙니다. 어둠을 밝히는 초정밀 레이저(丁火)의 심지를 깊고 오래 충전하는 시간입니다."',
        ilganLabel: '丁火(정화, 음화) — 꺼지지 않는 촛불·심리 코칭사',
        ...
        phase1: {
            title: '丁火 일간 4D 뇌지도',
            inner: '예민한 감수성과 높은 공감 능력. 상대의 감정을 본능적으로 읽어내는 심리 코칭사형 내면 구조입니다.',
        ...
        masterRoadmap: {
            ...
            leverages: [
                { type: 'Tech', title: '자동화 커리큘럼 지렛대', desc: '매번 동일하게 반복되는 기초 심리 교육은 시스템이 대신해주어야 합니다.', items: ['VOD 기반의 기초 사전 교육 시스템 배포', '매 세션별 자동화된 리포트 발송 프로세스(Make/AI 파이프라인)'] },
            ...
            coreRole: [
                '가장 섬세한 언어로 내담자의 방어막을 해제하는 심층 코칭사',
                '어둠에 갇힌 자들에게 개별적인 길을 제시하는 희망의 등대',
                '상대의 잠재력을 조용히 예열시켜 폭발하게 만드는 촉매제'
            ],
            microManual: {
                          "title": "마이크로 1:1 영혼 코칭 실행 매뉴얼",
                          "intro": "丁火(정화, 촛불·탐구자) 대표님, 60갑자 중 고유한 기질을 지닌 당신을 위한 1:1 맞춤형 마이크로 실행 가이드입니다. 세상을 향해 당신의 고귀한 가치를 빛내는 3대 감동 실천 솔루션을 전해드립니다.",
                          "sections": [
                                    {
                                              "title": "1. 💎 丁火(정화, 촛불·탐구자)의 완벽주의를 내려놓는 80% 미학의 기술",
                                              "desc": "원석이 정교한 보석으로 거듭나는 과정에는 수많은 마찰과 세공의 시간이 존재합니다. 丁火(정화, 촛불·탐구자) 대표님, 완성도 100점짜리 무결점 작품을 내놓으려 애쓰다, 정작 세상과의 소통을 멈추고 계셨던 적은 없으셨습니까? 80%의 진심이 담긴 미완성의 초안이, 세상의 빛을 보지 못한 100% 완벽보다 천 배 더 위대합니다. 오늘 당신의 날카로운 자책을 내려놓고 세상을 바꾸는 훌륭한 세공 도구로 사용하십시오.",
                                              "scenarioTitle": "[오늘 당장 실천하는 3단계 뇌 디버깅 루틴]",
                                              "steps": [
                                                        "1단계 [수용]: 오늘 하고 있던 작업 중 80% 완성된 것에 3초간 깊은 호흡 후 즉시 마침표 찍기",
                                                        "2단계 [전환]: '완벽하지 않아도 내 진심은 이미 충분히 빛난다'고 스스로에게 나직하게 말해주기",
                                              ...
                                              "insight": "💡 丁火(정화, 촛불·탐구자) 아키텍트의 마인드셋: \"나는 내 작품의 가장 엄격한 비판자가 아니라, 세상을 아름답게 바꾸는 정교한 빛의 세공사다.\""
                                    },
                                    {
                                              "title": "2. 🌿 사회적 압박감을 자유로운 성장으로 바꾸는 지혜",
                                              "desc": "사회적 책임감과 타인의 기대는 때로 당신을 가두는 단단한 감옥이 되기도 합니다. 모든 사람의 기대에 부응하려 애쓰지 마십시오. 당신은 남들의 기대치에 맞춰 다듬어진 장식품이 아니라, 스스로 온 영토를 비추는 단 하나의 자비로운 보석입니다. 타인의 평가에서 벗어날 때 당신의 가치는 진정한 빛을 발합니다.",
                                              ...
                                              "insight": "💡 丁火(정화, 촛불·탐구자) 비즈니스 마인드셋: \"타인의 인정보다 더 위대한 것은 나 자신과의 깊은 평화와 현존이다.\""
                                    },
                                    {
                                              "title": "3. 🌊 가슴속 창의성을 세상의 풍요로 연결하는 퀀텀 쉼프트",
                                              "desc": "당신의 가슴속에서 솟구치는 영감과 창의적 아이디어를 홀로 껴안고 계시지 마십시오. 세상으로 흘러가 사람들의 대지를 적실 때 비로소 거대한 풍요의 숲을 이룹니다. 머릿속에만 맴돌던 영감을 글이나 커뮤니케이션으로 세상과 연결하세요.",
                                              ...
                                              "insight": "💡 丁火(정화, 촛불·탐구자) 퀀텀 마인드셋: \"나의 창의적 영감은 세상을 이롭게 하는 가장 고귀한 선물이다.\""
                                    }
                          ]
                }
        }
    ...
    // ──────────────────────────────────────────────────────
    '戊': {
        heroQuote: '"당신의 경직은 막힘이 아닙니다. 만물을 품는 거대한 데이터 센터(戊土)의 단단한 서버 인프라를 세우는 중입니다."',
        ...
        masterRoadmap: {
            ...
            microManual: {
                          "title": "마이크로 1:1 영혼 코칭 실행 매뉴얼",
                          "intro": "戊土(무토, 태산·중심) 대표님, 60갑자 중 고유한 기질을 지닌 당신을 위한 1:1 맞춤형 마이크로 실행 가이드입니다. 세상을 향해 당신의 고귀한 가치를 빛내는 3대 감동 실천 솔루션을 전해드립니다.",
                          "sections": [
                                    {
                                              "title": "1. 💎 戊土(무토, 태산·중심)의 완벽주의를 내려놓는 80% 미학의 기술",
                                              "desc": "원석이 정교한 보석으로 거듭나는 과정에는 수많은 마찰과 세공의 시간이 존재합니다. 戊土(무토, 태산·중심) 대표님, 완성도 100점짜리 무결점 작품을 내놓으려 애쓰다, 정작 세상과의 소통을 멈추고 계셨던 적은 없으셨습니까? 80%의 진심이 담긴 미완성의 초안이, 세상의 빛을 보지 못한 100% 완벽보다 천 배 더 위대합니다. 오늘 당신의 날카로운 자책을 내려놓고 세상을 바꾸는 훌륭한 세공 도구로 사용하십시오.",
                                              "scenarioTitle": "[오늘 당장 실천하는 3단계 뇌 디버깅 루틴]",
                                              "steps": [
                                                        "1단계 [수용]: 오늘 하고 있던 작업 중 80% 완성된 것에 3초간 깊은 호흡 후 즉시 마침표 찍기",
                                                        "2단계 [전환]: '완벽하지 않아도 내 진심은 이미 충분히 빛난다'고 스스로에게 나직하게 말해주기",
                                              ...
                                              "insight": "💡 戊土(무토, 태산·중심) 아키텍트의 마인드셋: \"나는 내 작품의 가장 엄격한 비판자가 아니라, 세상을 아름답게 바꾸는 정교한 빛의 세공사다.\""
                                    },
                                    {
                                              "title": "2. 🌿 사회적 압박감을 자유로운 성장으로 바꾸는 지혜",
                                              "desc": "사회적 책임감과 타인의 기대는 때로 당신을 가두는 단단한 감옥이 되기도 합니다. 모든 사람의 기대에 부응하려 애쓰지 마십시오. 당신은 남들의 기대치에 맞춰 다듬어진 장식품이 아니라, 스스로 온 영토를 비추는 단 하나의 자비로운 보석입니다. 타인의 평가에서 벗어날 때 당신의 가치는 진정한 빛을 발합니다.",
                                              ...
                                              "insight": "💡 戊土(무토, 태산·중심) 비즈니스 마인드셋: \"타인의 인정보다 더 위대한 것은 나 자신과의 깊은 평화와 현존이다.\""
                                    },
                                    {
                                              "title": "3. 🌊 가슴속 창의성을 세상의 풍요로 연결하는 퀀텀 쉼프트",
                                              "desc": "당신의 가슴속에서 솟구치는 영감과 창의적 아이디어를 홀로 껴안고 계시지 마십시오. 세상으로 흘러가 사람들의 대지를 적실 때 비로소 거대한 풍요의 숲을 이룹니다. 머릿속에만 맴돌던 영감을 글이나 커뮤니케이션으로 세상과 연결하세요.",
                                              ...
                                              "insight": "💡 戊土(무토, 태산·중심) 퀀텀 마인드셋: \"나의 창의적 영감은 세상을 이롭게 하는 가장 고귀한 선물이다.\""
                                    }
                          ]
                }
        }
    ...
    // ──────────────────────────────────────────────────────
    '己': {
        heroQuote: '"당신의 혼란은 흙탕물이 아닙니다. 모든 데이터를 안정적으로 담아낼 고성능 데이터베이스(己土)가 구축되는 과정입니다."',
        ...
        masterRoadmap: {
            ...
            microManual: {
                          "title": "마이크로 1:1 영혼 코칭 실행 매뉴얼",
                          "intro": "己土(기토, 옥토·포용자) 대표님, 60갑자 중 고유한 기질을 지닌 당신을 위한 1:1 맞춤형 마이크로 실행 가이드입니다. 세상을 향해 당신의 고귀한 가치를 빛내는 3대 감동 실천 솔루션을 전해드립니다.",
                          "sections": [
                                    {
                                              "title": "1. 💎 己土(기토, 옥토·포용자)의 완벽주의를 내려놓는 80% 미학의 기술",
                                              "desc": "원석이 정교한 보석으로 거듭나는 과정에는 수많은 마찰과 세공의 시간이 존재합니다. 己土(기토, 옥토·포용자) 대표님, 완성도 100점짜리 무결점 작품을 내놓으려 애쓰다, 정작 세상과의 소통을 멈추고 계셨던 적은 없으셨습니까? 80%의 진심이 담긴 미완성의 초안이, 세상의 빛을 보지 못한 100% 완벽보다 천 배 더 위대합니다. 오늘 당신의 날카로운 자책을 내려놓고 세상을 바꾸는 훌륭한 세공 도구로 사용하십시오.",
                                              "scenarioTitle": "[오늘 당장 실천하는 3단계 뇌 디버깅 루틴]",
                                              "steps": [
                                                        "1단계 [수용]: 오늘 하고 있던 작업 중 80% 완성된 것에 3초간 깊은 호흡 후 즉시 마침표 찍기",
                                                        "2단계 [전환]: '완벽하지 않아도 내 진심은 이미 충분히 빛난다'고 스스로에게 나직하게 말해주기",
                                              ...
                                              "insight": "💡 己土(기토, 옥토·포용자) 아키텍트의 마인드셋: \"나는 내 작품의 가장 엄격한 비판자가 아니라, 세상을 아름답게 바꾸는 정교한 빛의 세공사다.\""
                                    },
                                    {
                                              "title": "2. 🌿 사회적 압박감을 자유로운 성장으로 바꾸는 지혜",
                                              "desc": "사회적 책임감과 타인의 기대는 때로 당신을 가두는 단단한 감옥이 되기도 합니다. 모든 사람의 기대에 부응하려 애쓰지 마십시오. 당신은 남들의 기대치에 맞춰 다듬어진 장식품이 아니라, 스스로 온 영토를 비추는 단 하나의 자비로운 보석입니다. 타인의 평가에서 벗어날 때 당신의 가치는 진정한 빛을 발합니다.",
                                              ...
                                              "insight": "💡 己土(기토, 옥토·포용자) 비즈니스 마인드셋: \"타인의 인정보다 더 위대한 것은 나 자신과의 깊은 평화와 현존이다.\""
                                    },
                                    {
                                              "title": "3. 🌊 가슴속 창의성을 세상의 풍요로 연결하는 퀀텀 쉼프트",
                                              "desc": "당신의 가슴속에서 솟구치는 영감과 창의적 아이디어를 홀로 껴안고 계시지 마십시오. 세상으로 흘러가 사람들의 대지를 적실 때 비로소 거대한 풍요의 숲을 이룹니다. 머릿속에만 맴돌던 영감을 글이나 커뮤니케이션으로 세상과 연결하세요.",
                                              ...
                                              "insight": "💡 己土(기토, 옥토·포용자) 퀀텀 마인드셋: \"나의 창의적 영감은 세상을 이롭게 하는 가장 고귀한 선물이다.\""
                                    }
                          ]
                }
        }
    ...
    // ──────────────────────────────────────────────────────
    '庚': {
        heroQuote: '"당신의 저항은 단절이 아닙니다. 거친 하드웨어(庚金)에서 세상을 돌파할 최적의 코어를 갈아내는 담금질입니다."',
        ...
        masterRoadmap: {
            ...
            microManual: {
                          "title": "마이크로 1:1 영혼 코칭 실행 매뉴얼",
                          "intro": "庚金(경금, 원석·결단) 대표님, 60갑자 중 고유한 기질을 지닌 당신을 위한 1:1 맞춤형 마이크로 실행 가이드입니다. 세상을 향해 당신의 고귀한 가치를 빛내는 3대 감동 실천 솔루션을 전해드립니다.",
                          "sections": [
                                    {
                                              "title": "1. 💎 庚金(경금, 원석·결단)의 완벽주의를 내려놓는 80% 미학의 기술",
                                              "desc": "원석이 정교한 보석으로 거듭나는 과정에는 수많은 마찰과 세공의 시간이 존재합니다. 庚金(경금, 원석·결단) 대표님, 완성도 100점짜리 무결점 작품을 내놓으려 애쓰다, 정작 세상과의 소통을 멈추고 계셨던 적은 없으셨습니까? 80%의 진심이 담긴 미완성의 초안이, 세상의 빛을 보지 못한 100% 완벽보다 천 배 더 위대합니다. 오늘 당신의 날카로운 자책을 내려놓고 세상을 바꾸는 훌륭한 세공 도구로 사용하십시오.",
                                              "scenarioTitle": "[오늘 당장 실천하는 3단계 뇌 디버깅 루틴]",
                                              "steps": [
                                                        "1단계 [수용]: 오늘 하고 있던 작업 중 80% 완성된 것에 3초간 깊은 호흡 후 즉시 마침표 찍기",
                                                        "2단계 [전환]: '완벽하지 않아도 내 진심은 이미 충분히 빛난다'고 스스로에게 나직하게 말해주기",
                                              ...
                                              "insight": "💡 庚金(경금, 원석·결단) 아키텍트의 마인드셋: \"나는 내 작품의 가장 엄격한 비판자가 아니라, 세상을 아름답게 바꾸는 정교한 빛의 세공사다.\""
                                    },
                                    {
                                              "title": "2. 🌿 사회적 압박감을 자유로운 성장으로 바꾸는 지혜",
                                              "desc": "사회적 책임감과 타인의 기대는 때로 당신을 가두는 단단한 감옥이 되기도 합니다. 모든 사람의 기대에 부응하려 애쓰지 마십시오. 당신은 남들의 기대치에 맞춰 다듬어진 장식품이 아니라, 스스로 온 영토를 비추는 단 하나의 자비로운 보석입니다. 타인의 평가에서 벗어날 때 당신의 가치는 진정한 빛을 발합니다.",
                                              ...
                                              "insight": "💡 庚金(경금, 원석·결단) 비즈니스 마인드셋: \"타인의 인정보다 더 위대한 것은 나 자신과의 깊은 평화와 현존이다.\""
                                    },
                                    {
                                              "title": "3. 🌊 가슴속 창의성을 세상의 풍요로 연결하는 퀀텀 쉼프트",
                                              "desc": "당신의 가슴속에서 솟구치는 영감과 창의적 아이디어를 홀로 껴안고 계시지 마십시오. 세상으로 흘러가 사람들의 대지를 적실 때 비로소 거대한 풍요의 숲을 이룹니다. 머릿속에만 맴돌던 영감을 글이나 커뮤니케이션으로 세상과 연결하세요.",
                                              ...
                                              "insight": "💡 庚金(경금, 원석·결단) 퀀텀 마인드셋: \"나의 창의적 영감은 세상을 이롭게 하는 가장 고귀한 선물이다.\""
                                    }
                          ]
                }
        }
    ...
    // ──────────────────────────────────────────────────────
    '壬': {
        heroQuote: '"당신의 범람은 혼란이 아닙니다. 거대한 빅데이터 바다(壬水)처럼 만물을 품고 도약할 퀀텀 인프라를 구축하는 깊이입니다."',
        ...
        masterRoadmap: {
            ...
            microManual: {
                          "title": "마이크로 1:1 영혼 코칭 실행 매뉴얼",
                          "intro": "壬水(임수, 대해·지혜) 대표님, 60갑자 중 고유한 기질을 지닌 당신을 위한 1:1 맞춤형 마이크로 실행 가이드입니다. 세상을 향해 당신의 고귀한 가치를 빛내는 3대 감동 실천 솔루션을 전해드립니다.",
                          "sections": [
                                    {
                                              "title": "1. 💎 壬水(임수, 대해·지혜)의 완벽주의를 내려놓는 80% 미학의 기술",
                                              "desc": "원석이 정교한 보석으로 거듭나는 과정에는 수많은 마찰과 세공의 시간이 존재합니다. 壬水(임수, 대해·지혜) 대표님, 완성도 100점짜리 무결점 작품을 내놓으려 애쓰다, 정작 세상과의 소통을 멈추고 계셨던 적은 없으셨습니까? 80%의 진심이 담긴 미완성의 초안이, 세상의 빛을 보지 못한 100% 완벽보다 천 배 더 위대합니다. 오늘 당신의 날카로운 자책을 내려놓고 세상을 바꾸는 훌륭한 세공 도구로 사용하십시오.",
                                              "scenarioTitle": "[오늘 당장 실천하는 3단계 뇌 디버깅 루틴]",
                                              "steps": [
                                                        "1단계 [수용]: 오늘 하고 있던 작업 중 80% 완성된 것에 3초간 깊은 호흡 후 즉시 마침표 찍기",
                                                        "2단계 [전환]: '완벽하지 않아도 내 진심은 이미 충분히 빛난다'고 스스로에게 나직하게 말해주기",
                                              ...
                                              "insight": "💡 壬水(임수, 대해·지혜) 아키텍트의 마인드셋: \"나는 내 작품의 가장 엄격한 비판자가 아니라, 세상을 아름답게 바꾸는 정교한 빛의 세공사다.\""
                                    },
                                    {
                                              "title": "2. 🌿 사회적 압박감을 자유로운 성장으로 바꾸는 지혜",
                                              "desc": "사회적 책임감과 타인의 기대는 때로 당신을 가두는 단단한 감옥이 되기도 합니다. 모든 사람의 기대에 부응하려 애쓰지 마십시오. 당신은 남들의 기대치에 맞춰 다듬어진 장식품이 아니라, 스스로 온 영토를 비추는 단 하나의 자비로운 보석입니다. 타인의 평가에서 벗어날 때 당신의 가치는 진정한 빛을 발합니다.",
                                              ...
                                              "insight": "💡 壬水(임수, 대해·지혜) 비즈니스 마인드셋: \"타인의 인정보다 더 위대한 것은 나 자신과의 깊은 평화와 현존이다.\""
                                    },
                                    {
                                              "title": "3. 🌊 가슴속 창의성을 세상의 풍요로 연결하는 퀀텀 쉼프트",
                                              "desc": "당신의 가슴속에서 솟구치는 영감과 창의적 아이디어를 홀로 껴안고 계시지 마십시오. 세상으로 흘러가 사람들의 대지를 적실 때 비로소 거대한 풍요의 숲을 이룹니다. 머릿속에만 맴돌던 영감을 글이나 커뮤니케이션으로 세상과 연결하세요.",
                                              ...
                                              "insight": "💡 壬水(임수, 대해·지혜) 퀀텀 마인드셋: \"나의 창의적 영감은 세상을 이롭게 하는 가장 고귀한 선물이다.\""
                                    }
                          ]
                }
        }
    ...
    // ──────────────────────────────────────────────────────
    '癸': {
        heroQuote: '"당신의 고요는 마름이 아닙니다. 과열된 코어를 식히고 깊은 통찰을 추출하는 쿨링 시스템(癸水)의 작동 시간입니다."',
        ...
        masterRoadmap: {
            engines: [
                ...
                { label: '중앙 처리 장치 (癸水)', title: '영적/감성적 힐링 프로세서', desc: '논리와 이성을 넘어선 직관과 육감으로 상대방의 영혼적 결핍을 순식간에 분석해 내는 스캐너입니다.' },
            ...
            microManual: {
                          "title": "마이크로 1:1 영혼 코칭 실행 매뉴얼",
                          "intro": "癸水(계수, 샘물·통찰) 대표님, 60갑자 중 고유한 기질을 지닌 당신을 위한 1:1 맞춤형 마이크로 실행 가이드입니다. 세상을 향해 당신의 고귀한 가치를 빛내는 3대 감동 실천 솔루션을 전해드립니다.",
                          "sections": [
                                    {
                                              "title": "1. 💎 癸水(계수, 샘물·통찰)의 완벽주의를 내려놓는 80% 미학의 기술",
                                              "desc": "원석이 정교한 보석으로 거듭나는 과정에는 수많은 마찰과 세공의 시간이 존재합니다. 癸水(계수, 샘물·통찰) 대표님, 완성도 100점짜리 무결점 작품을 내놓으려 애쓰다, 정작 세상과의 소통을 멈추고 계셨던 적은 없으셨습니까? 80%의 진심이 담긴 미완성의 초안이, 세상의 빛을 보지 못한 100% 완벽보다 천 배 더 위대합니다. 오늘 당신의 날카로운 자책을 내려놓고 세상을 바꾸는 훌륭한 세공 도구로 사용하십시오.",
                                              "scenarioTitle": "[오늘 당장 실천하는 3단계 뇌 디버깅 루틴]",
                                              "steps": [
                                                        "1단계 [수용]: 오늘 하고 있던 작업 중 80% 완성된 것에 3초간 깊은 호흡 후 즉시 마침표 찍기",
                                                        "2단계 [전환]: '완벽하지 않아도 내 진심은 이미 충분히 빛난다'고 스스로에게 나직하게 말해주기",
                                              ...
                                              "insight": "💡 癸水(계수, 샘물·통찰) 아키텍트의 마인드셋: \"나는 내 작품의 가장 엄격한 비판자가 아니라, 세상을 아름답게 바꾸는 정교한 빛의 세공사다.\""
                                    },
                                    {
                                              "title": "2. 🌿 사회적 압박감을 자유로운 성장으로 바꾸는 지혜",
                                              "desc": "사회적 책임감과 타인의 기대는 때로 당신을 가두는 단단한 감옥이 되기도 합니다. 모든 사람의 기대에 부응하려 애쓰지 마십시오. 당신은 남들의 기대치에 맞춰 다듬어진 장식품이 아니라, 스스로 온 영토를 비추는 단 하나의 자비로운 보석입니다. 타인의 평가에서 벗어날 때 당신의 가치는 진정한 빛을 발합니다.",
                                              ...
                                              "insight": "💡 癸水(계수, 샘물·통찰) 비즈니스 마인드셋: \"타인의 인정보다 더 위대한 것은 나 자신과의 깊은 평화와 현존이다.\""
                                    },
                                    {
                                              "title": "3. 🌊 가슴속 창의성을 세상의 풍요로 연결하는 퀀텀 쉼프트",
                                              "desc": "당신의 가슴속에서 솟구치는 영감과 창의적 아이디어를 홀로 껴안고 계시지 마십시오. 세상으로 흘러가 사람들의 대지를 적실 때 비로소 거대한 풍요의 숲을 이룹니다. 머릿속에만 맴돌던 영감을 글이나 커뮤니케이션으로 세상과 연결하세요.",
                                              ...
                                              "insight": "💡 癸水(계수, 샘물·통찰) 퀀텀 마인드셋: \"나의 창의적 영감은 세상을 이롭게 하는 가장 고귀한 선물이다.\""
                                    }
                          ]
                }
        }
...
// ─────────────────────────────────────────────
// System Guardrail: 10대 일간별 시스템 공학 / 뇌과학 / 심리학 통합 명언 생성기
// ─────────────────────────────────────────────
function getDynamicHeroQuote(sajuInfo: any, coaching: IlganCoaching): string {
    if (!sajuInfo || !sajuInfo.dayStem || !coaching) {
        return '"당신의 고통은 버그가 아닙니다. 더 고차원의 시스템으로 진화하기 위한 디버깅 과정입니다."';
    }

    const SYSTEM_METAPHOR_QUOTES: Record<string, string> = {
        '甲': '"당신의 고통은 부러짐이 아닙니다. 새로운 영역을 개척하는 메인 프레임(甲木)의 확장 스케일링입니다."',
        '乙': '"당신의 시련은 시듦이 아닙니다. 어떤 환경에도 유연하게 연결되는 분산 네트워크(乙木)의 적응력입니다."',
        '丙': '"당신의 과열은 번아웃이 아닙니다. 온 세상을 밝히는 중앙 프로세서(丙火)의 기운을 절제하는 법을 배우는 센싱 과정입니다."',
        '丁': '"당신의 방전은 소멸이 아닙니다. 어둠을 밝히는 초정밀 레이저(丁火)의 심지를 깊고 오래 충전하는 시간입니다."',
        '戊': '"당신의 경직은 막힘이 아닙니다. 만물을 품는 거대한 데이터 센터(戊土)의 단단한 서버 인프라를 세우는 중입니다."',
        '己': '"당신의 혼란은 흙탕물이 아닙니다. 모든 데이터를 안정적으로 담아낼 고성능 데이터베이스(己土)가 구축되는 과정입니다."',
        '庚': '"당신의 저항은 단절이 아닙니다. 거친 하드웨어(庚金)에서 세상을 돌파할 최적의 코어를 갈아내는 담금질입니다."',
        '辛': '"당신의 고통은 버그가 아닙니다. 완벽한 디버깅 CPU(辛金)로 빛나기 위한 정밀 프로세싱 과정입니다."',
        '壬': '"당신의 범람은 혼란이 아닙니다. 거대한 빅데이터 바다(壬水)처럼 만물을 품고 도약할 퀀텀 인프라를 구축하는 깊이입니다."',
        '癸': '"당신의 고요는 마름이 아닙니다. 과열된 코어를 식히고 깊은 통찰을 추출하는 쿨링 시스템(癸水)의 작동 시간입니다."'
    };

    return SYSTEM_METAPHOR_QUOTES[sajuInfo.dayStem] || coaching.heroQuote || '"당신의 고통은 버그가 아닙니다. 더 고차원의 시스템으로 진화하기 위한 디버깅 과정입니다."';
}
...
{coaching.neuralPrompts.map(p => {
                                ...
                                <section>
                                    <SectionHeader phase="Phase 5 💻" title="명심 트리플 코어 분석 (기후·균형·사회)" />
                                ...
                                <section>
                                    <SectionHeader phase="Phase 7 ⚠️" title="사회 기여 충돌 분석 (Anti-Pattern 분석)" />
                                    <div className="p-4 rounded-2xl border border-white/5 bg-slate-900/40">
                                ...
                                <section>
                                    <SectionHeader phase="Phase 10" title="명심 AI 분석 모델" />
                                    <div className="p-5 rounded-2xl border border-indigo-500/20 bg-[#1e1b4b]/40 space-y-5">
                                        <div className="text-center">
                                            ...
                                            <p className="text-xs text-gray-400 break-keep">현재 가지고 있는 직업적 고민이나 사회적 기여 방향을 입력하시면, 명리학과 서양 심리학(ACT/CBT)을 결합한 맞춤형 분석 리포트를 생성합니다.</p>
                                        </div>
                                        <textarea
                                            value={userConcern}
            ...
            {/* ── [Prompt Essay Solution Paywall Modal (890원/890원)] ── */}
            <AnimatePresence>
                            ...
                            <div className="space-y-4 text-slate-300 text-sm leading-relaxed font-sans pr-2 overflow-y-auto custom-scrollbar">
                                ...
                                {!isMicroEssayUnlocked && !isAllPassUnlocked ? (
                                    ...
                                    <div className="relative overflow-hidden rounded-2xl border border-yellow-500/30 p-6 bg-[#181526]/90 shadow-2xl mt-4">
                                        <div className="filter blur-[6px] select-none text-slate-500 text-xs space-y-3 opacity-60 pointer-events-none">
                                            <p>▒▒▒▒▒▒ 01. 마이크로 1:1 영혼 코칭: "더 이상 모든 것을 백지에서 시작하지 마세요" ▒▒▒▒▒▒</p>
