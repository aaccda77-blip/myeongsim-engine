  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-3 bg-slate-950/85 backdrop-blur-lg overflow-y-auto">
      ...
      >
        ...
        {/* Header Section */}
        <div className="p-4 md:p-6 border-b border-white/5 flex justify-between items-center relative z-10 bg-slate-950/20 backdrop-blur-sm">
          <div>
        ...
        <div className={`px-4 md:px-6 py-2.5 border-b ${textDark ? 'bg-slate-100 border-slate-200' : 'bg-slate-950/60 border-white/5'} flex flex-nowrap overflow-x-auto scrollbar-none gap-1.5 md:gap-2 relative z-10 w-full`}>
          {[
        ...
        <div className={`p-3 md:p-4 ${textDark ? 'bg-slate-100 border-b border-slate-200' : 'bg-slate-950/40 border-b border-white/5'} px-4 md:px-6 flex flex-col md:flex-row gap-3 items-center justify-between relative z-10`}>
