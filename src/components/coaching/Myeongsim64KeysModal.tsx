...
const CONCEPT_GUIDE_DATA: Record<string, { title: string; subtitle: string; desc: string; metaphor: string; action: string }> = {
  ...
  '1ST HALF': {
    ...
    subtitle: '단단한 바위 아래서 묵묵히 내실을 다지며 뿌리를 뻗는 응축의 시간',
    metaphor: '🌱 거친 단련 속에서 깊은 중심을 세워나가는 굳건한 뿌리',
    desc: '세상의 거친 파도와 관계의 소용돌이 속에서 부딪치고 깨어지며, 스스로를 둘러싼 단단한 에고의 껍질을 부수고 영혼의 뿌리를 내리는 시기입니다. 겉보기에는 갈등과 시련처럼 느껴지는 일상의 모든 아픔들은, 사실 당신이라는 존재의 그릇을 더 크고 단단하게 빚어내기 위해 대자연이 준비한 단단한 단련의 축복이자 거름입니다.',
  ...
  '2ND HALF': {
    ...
    desc: '단단한 연마의 고개를 넘어 벼랑 끝 같았던 중대한 전환점을 기어이 통과한 뒤, 마침내 내면 깊은 심연에서 건져 올린 순수한 자각의 빛으로 세상 사람들의 어두운 아픔을 어루만지고 치유하는 성숙의 시기입니다. 내가 먼저 아파 보았기에 상처받은 타인의 고통을 아무런 편견 없이 자비롭게 안아줄 수 있는 거대한 하늘의 가슴이 활짝 열립니다.',
