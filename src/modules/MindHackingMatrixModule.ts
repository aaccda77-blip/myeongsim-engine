...
export const MATRIX_PHASES: MatrixPhase[] = [
  ...
  },
  {
    ...
    psychScience: 'Jon Kabat-Zinn의 MBSR + Zindel Segal의 MBCT: 마음챙김 명상을 통한 우울증 재발 방지율 44% 감소 (현장 코칭 근거)',
  ...
  },
  {
    ...
    psychScience: 'Marsha Linehan의 DBT: 경계선 인격장애 코칭 성공률 77%, 자해 행동 50% 감소 (RCT 현장 코칭 근거). 핵심 4모듈: 마음챙김, 대인관계 효과성, 감정조절, 고통감내',
  ...
  },
  {
    ...
    fusionPrinciple: 'ACT는 고통을 없애려 싸우는 대신, 그것을 가방에 넣고 자신이 가치 있게 여기는 방향으로 걸어가는 코칭법입니다. 이는 사주에서 나의 가장 큰 무기이자 지향점인 "용신(用神)"을 찾아 실천하는 과정과 완벽히 오버랩됩니다.',
    ...
    psychScience: 'Steven Hayes의 ACT: 심리적 유연성(Psychological Flexibility) 6축 모델. 300+ RCT 논문으로 검증된 초현대 코칭법. 핵심: 수용, 탈융합, 현재 접촉, 맥락적 자기, 가치, 전념 행동',
