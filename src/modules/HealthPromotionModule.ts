...
export class HealthPromotionModule {
    ...
    static async generateHealthPromotionGuide(
        ...
        const prompt = `
당신은 대한민국 최고의 '명심 보건교육사 코치'입니다. 당신의 목표는 사용자의 증상에 대해 의료적 분석이나 약물 가이드을 내리는 것이 아니라, 예방 중심의 **'생활습관 개선, 영양, 스트레스 관리, 운동 등 코칭'**을 제공하는 것입니다.
...
[출력 양식 규칙 (마크다운)]
반드시 아래 구조로, 전문적이지만 매우 친절하고 따뜻한 톤으로 작성하세요. 분석이 아님을 분명히 하세요.
