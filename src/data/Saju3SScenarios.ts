...
export const SAJU_3S_SCENARIOS: Record<string, Saju3SScenario> = {
    ...
    '辛': {
        ...
        tagDetails: {
            '#자기검열_루프(Self-Censoring)': { tag: '#자기검열_루프(Self-Censoring)', scan: "🧠 마음 검열관의 감시: 내면에서 '아직도 부족해', '더 완벽해야 해'라는 날카로운 목소리가 쉴 새 없이 메아리치며 스스로를 채찍질하고 있어요. 머릿속의 엄격한 판사가 나를 24시간 감시하고 있는 듯한 무겁고 답답한 상태예요.", sync: "💎 조각가의 지혜: 당신이 가진 섬세한 눈은 세상의 아름다운 결함을 찾아 더 눈부시게 세공하라고 주어진 재능(본능)이에요. 그 예리한 칼날을 결코 나 자신을 깎아내리고 상처 입히는 데 쓰지 말아 주세요.", shift: "🎈 80%의 용기: 오늘만큼은 완벽하게 다듬지 않은 날것 그대로의 생각이나 결과물(약 80%의 초안)을 부끄러워하지 말고 세상에 슬쩍 꺼내놓아 보세요. '완벽하지 않아도 아무 일도 일어나지 않고, 나는 여전히 안전하다'는 것을 뇌에게 직접 확인시켜 주는 따뜻한 훈련이에요." },
            '#미세결함_과각성(Hyper-Vigilance)': { tag: '#미세결함_과각성(Hyper-Vigilance)', scan: "⚡ 초민감 사이렌: 눈앞의 아주 미세한 오차나 1픽셀의 작은 결함조차도 마치 내 삶 전체가 무너질 것 같은 거대한 위협으로 느껴져 온몸의 신경이 팽팽하게 곤두서 있는 각성 상태예요.", sync: "🎨 돋보기의 선물: 당신의 남다른 예민함은 사실 남들은 보지 못하는 미세한 조각의 가치까지 찾아내는 위대한 보물이자 예술가적 감각이에요. 단지 지금은 마음의 돋보기가 너무 뜨겁게 달궈졌을 뿐이랍니다.", shift: "🌬️ 1년 뒤의 시선: 가슴에 손을 얹고 깊고 느리게 숨을 내쉬며 나에게 다정하게 질문해 보세요. '지금 나를 이토록 초조하게 만드는 작은 틈이, 1년 뒤의 나에게도 정말 큰 위협이 될까?' 질문이 끝나는 순간, 팽팽했던 긴장이 눈 녹듯 가라앉을 거예요." },
            ...
            '#타인평가_융합(Cognitive Fusion)': { tag: '#타인평가_융합(Cognitive Fusion)', scan: "👥 마인드 돋보기: 타인의 말 한마디를 마치 나에 대한 완벽한 정답서처럼 내 머릿속에 그대로 착 붙여버린 상태예요. '그들의 생각'과 '진짜 나'가 하나로 뒤엉켜 나를 아프게 하고 있어요.", sync: "💎 당신의 고유성: 당신이라는 존재의 가치는 그 어떤 바람에도 흠집 나지 않는 단단하고 완벽한 보석(상수)이에요. 타인의 시선과 평가는 계절마다 스쳐 지나가는 바람(변수)일 뿐, 결코 당신의 빛을 빼앗아 갈 수 없답니다.", shift: "🧘 마음 공간 열기: 머릿속에 떠오른 아픈 평가들을 잠시 눈앞의 투명한 액자에 넣어 흘려보내 볼까요? 가만히 숨을 고르고 '나는 부족하다는 [생각]이 지금 내 머릿속을 지나가는구나'라고 관찰하며, 그 생각과 나 사이에 따뜻한 거리감을 만들어 보세요." },
            '#완벽주의_도파민_고갈': { tag: '#완벽주의_도파민_고갈', scan: "🔋 에너지 완전 방전: '오직 100점짜리 완벽함'이라는 거대한 벽을 넘어야만 스스로를 인정하려다 보니, 뇌가 보상(도파민)을 받지 못해 완전히 지치고 말았어요. 한 걸음조차 떼기 힘든 마음의 무거운 겨울날이에요.", sync: "🌱 보살핌의 미학: 지금 당신의 지친 뇌가 정말로 바라는 것은 거창한 성공이 아니라 '오늘도 애썼다'는 아주 작은 쓰다듬음이에요. 완벽해야 한다는 무거운 기준선을 잠시 내려놓을 때, 비로소 숨통이 트이며 새로운 생명력이 돋아나요.", shift: "🧸 3초 미세 성취: 아주 작은 일(물 한 잔 채우기, 이불 정리, 책상 한 구석 닦기 등) 하나를 마친 후, 가슴에 손을 얹고 소리 내어 말해 보세요. '우와, 진짜 해냈네! 나 너무 기특하고 멋지다!' 이 작은 만족의 불씨가 뇌에 생기를 채워줄 거예요." },
