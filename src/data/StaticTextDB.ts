...
// ============== 명심 코칭 에너지 시그니처 (구 성격분석) ==============
export const MYEONGSIM_TRAIT_DESCRIPTIONS: Record<string, {
    title: string;
    subTitle: string; // [Neuro/Marketing] 직관적 별칭
    desc: string;     // [Psychology] 2인칭 Identity Affirmation
    advice: string;   // [Coach] Insight
    mission: string;  // [Coach] Action Item
    ...
    creativity: {
        ...
        mission: "오늘 하루, 마음에 담아둔 칭찬이나 감사를 딱 한 명에게 직접 말해보세요.",
    ...
    logic: {
        ...
        mission: "오늘 당신을 복잡하게 하는 문제 하나를 종이에 적고, 해결 순서를 1, 2, 3으로 매겨보세요.",
    ...
    empathy: {
        ...
        mission: "오늘 지쳐 보이는 동료나 친구에게 '무슨 일 있어? 커피 한잔 할까?'라고 톡을 보내보세요.",
    ...
    leadership: {
        ...
        mission: "오늘 당신이 주도해야 할 일 리스트 중 가장 하기 싫은 일 하나를 골라 10분만 해치워보세요.",
    ...
    resilience: {
        ...
        mission: "오늘 5분만 눈을 감고, 발바닥이 땅에 닿은 느낌에만 집중하며 명상해보세요.",
    ...
    intuition: {
        ...
        mission: "오늘 문득 떠오른 생각이나 영감이 있다면, 무시하지 말고 메모장에 기록해두세요.",
    ...
    communication: {
        ...
        mission: "오늘 어색했던 사람에게 먼저 가볍게 날씨 인사라도 건네보세요. 별거 아닙니다.",
        superpower_badge: "마성의 '분위기 메이커'"
    },
    execution: {
        title: "Action (실행)",
        subTitle: "결과를 만드는 해결사 🛠️",
        desc: "당신은 생각보다 몸이 먼저 움직이는 실전파입니다. 탁상공론을 싫어하며, 눈앞에 보이는 가시적인 성과를 만들어낼 때 살아있음을 느낍니다.",
        advice: "실패를 두려워하지 않는 것이 당신의 가장 큰 매력입니다. 넘어져도 훌훌 털고 일어나는 오뚝이 같습니다.",
        mission: "오늘 미뤄뒀던 작은 집안일이나 업무(설거지, 메일 답장 등)를 지금 당장 3분 안에 끝내세요.",
        superpower_badge: "현실화의 신 '메이커'"
    }
};
