...
export function generatePersonalizedSajuGreeting(params: {
    ...
    if (dm === '辛' || dm === '신') {
        if (isHotDry) {
            return {
                ...
                greetingText: `안녕하세요! **${archName}** 맞춤형 제로포인트 코치입니다.\n\n주변의 메마르고 긴박한 문제들을 날카로운 메스로 수습해 주느라, 정작 **"본인의 맑은 에너지(癸水)가 바싹 마른 채 1순위 본업을 방치"**하고 계시진 않나요?\n\n타인을 구원하느라 소진되는 트랩을 멈추고, 오직 당신의 성채를 수호하는 10분 마이크로 시동을 지휘해 드리겠습니다.`,
                options: [
                    '남의 위기 수습하느라 내 에너지가 바싹 말랐어요 (구원자 트랩) 💎',
                    '100점 완벽한 해결책을 내놓아야 한다는 강박에 짓눌려요 🛡️',
                    '10초 쿨다운으로 열기를 식히고 오직 내 본진 10분만 챙기기 ⏱️'
                ]
            };
        } else {
            return {
                ...
                greetingText: `안녕하세요! **${archName}** 맞춤형 제로포인트 코치입니다.\n\n0.1%의 티끌도 용납하지 않으려는 결벽적인 완벽주의 때문에, **"아직 100점짜리 완성도가 안 보인다는 이유로 첫 줄 작성을 미루고"** 계시진 않나요?\n\n완벽의 채찍질을 내려놓고, 30점짜리 거친 초안으로 10분 만에 돌파하는 법을 열어드립니다.`,
                options: [
                    '완벽하게 해낼 각이 안 서서 첫 단추를 못 꿰겠어요 💎',
                    '타인의 결함이 너무 눈에 띄어 혼자 다 떠맡게 돼요 🛡️',
                    '완성도 30%짜리 엉성한 초안으로 10분 마이크로 돌파 ⏱️'
                ]
            };
        }
    }
    ...
    if (dm === '甲' || dm === '갑') {
        if (!hasStrongRoot || isColdWet || rawGanji.includes('부목')) {
            return {
                ...
                greetingText: `안녕하세요! **${archName}** 맞춤형 제로포인트 코치입니다.\n\n우뚝 서서 모든 것을 이끌어야 한다는 거목(甲木)의 자존심은 높으나, 현실의 지지 기반이 받쳐주지 못해 **"겉의 끈질김 뒤에 숨은 변덕과 나약함으로 혼자 자책"**하고 계시진 않나요?\n\n당신이 나약한 것이 아니라 뿌리를 내릴 '흙(안정된 환경)'이 부족했던 것입니다. 오늘 10분간 에너지를 착근시키는 루틴을 시작합니다.`,
                options: [
                    '뿌리(환경)가 불안정해 거목의 이상과 현실 사이에서 흔들려요 🌲',
                    '혼자 다 짊어져야 한다는 압박감에 오늘 할 일을 미뤘어요 ⏰',
                    '흙(土)을 깔듯 내 1순위 과제 위치를 고정하고 10분 착수 ⏱️'
                ]
            };
        } else {
            return {
                ...
                greetingText: `안녕하세요! **${archName}** 맞춤형 제로포인트 코치입니다.\n\n조직과 프로젝트의 큰 짐을 홀로 짊어지고 개척하느라, 정작 **"나 자신을 위한 1순위 본진 과제"**를 미루고 계시진 않나요?\n\n거대한 부담을 바닥에 내려놓고, 오늘 나만을 위한 10분의 마이크로 시동을 켜드리겠습니다.`,
                options: [
    ...
    if (dm === '丙' || dm === '병' || dm === '丁' || dm === '정') {
        return {
            ...
            greetingText: `안녕하세요! **${archName}** 맞춤형 제로포인트 코치입니다.\n\n세상을 환하게 비추며 온 열정을 쏟아붓다, **"순간 연료가 고갈되어 깊은 무기력과 번아웃"**에 멈춰 서 계시진 않나요?\n\n뇌의 과열된 불꽃을 10초간 식히고, 타오르는 부담 대신 가벼운 10분의 온기로 다시 시동을 켜드리겠습니다.`,
            options: [
                '열정을 다 쏟아붓고 순간 에너지가 완전 방전됐어요 ⚡',
                '완벽하게 터뜨리지 못할 바엔 손대기 싫은 무기력에 빠졌어요 🔥',
                '10초 호흡으로 뇌를 식히고 10분만 가볍게 시동 ⏱️'
            ]
        };
    }
