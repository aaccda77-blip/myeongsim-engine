...
export function generateZeroPointMusicTrack(
    ...
    if (selectedEmotion === 'rush' || dGan === '丙' || dGan === '丁') {
        ...
        subTitle = `${p.dGan}${p.dJi}일주 맞춤 제로포인트 힐링송 (65 BPM)`;
        verses = [
        ...
        subTitle = `${p.dGan}${p.dJi}일주 맞춤 제로포인트 힐링송 (75 BPM)`;
        verses = [
        ...
        subTitle = `${p.dGan}${p.dJi}일주 맞춤 제로포인트 힐링송 (70 BPM)`;
        verses = [
        ...
        subTitle = `${p.dGan}${p.dJi}일주 맞춤 제로포인트 힐링송 (72 BPM)`;
        verses = [
        ...
        subTitle = `${p.dGan}${p.dJi}일주 맞춤 제로포인트 힐링송 (80 BPM)`;
        verses = [
